...
These aggregated statistics provide comprehensive dataset characteristics and enable full reproducibility of the optimization methodology and results without requiring access to individual signal records. The complete signal datasets (49,940 Forex signals and 34,232 Index signals) are available upon reasonable request from the corresponding author, subject to data sharing agreements.
