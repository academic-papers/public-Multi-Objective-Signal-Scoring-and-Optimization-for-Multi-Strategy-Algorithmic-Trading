...
**Full signal datasets are NOT included in this repository** due to data sharing agreements and intellectual property considerations. The trading signals used in this study were generated by proprietary technical trading systems, and the participating traders have not consented to public disclosure of their individual signal data. 

However, **all statistical summaries and aggregated data necessary for reproducibility and validation are included**:
- Complete signal statistics (counts, distributions, RTR statistics)
- Strategy performance metrics for all periods
- All optimization results and analysis outputs
- Complete parameter specifications

These aggregated statistics provide comprehensive dataset characteristics and enable full reproducibility of the optimization methodology and results without requiring access to individual signal records. The complete signal datasets (49,940 Forex and 34,232 Index signals) are available upon reasonable request from the corresponding author, subject to data sharing agreements.
...
**Note on Data Availability**: The full signal datasets (individual signal records) are not included in this repository due to data sharing agreements with participating traders who have not consented to public disclosure of their proprietary technical trading system signals. However, all aggregated statistics, performance metrics, and optimization results necessary for complete reproducibility and validation are provided. These statistics files provide comprehensive dataset characteristics and enable full reproducibility of the optimization methodology, statistical analyses, and result validation without requiring access to individual signal records.
...
**Data Sharing Considerations**: The full signal datasets (individual signal records) are not publicly available due to data sharing agreements. The trading signals were generated by proprietary technical trading systems, and participating traders have not consented to public disclosure of their individual signal data. All aggregated statistics, performance metrics, and optimization results necessary for reproducibility and validation are included in this repository. These statistics provide complete dataset characteristics and enable full investigation and validation of the optimization methodology and results.
...
**Note**: Full signal datasets (49,940 Forex and 34,232 Index signals) are not included due to data sharing agreements with participating traders who have not consented to public disclosure of their proprietary technical trading system signals. However, all statistics, performance metrics, and optimization results necessary for reproducibility and validation are included. The complete signal datasets are available upon reasonable request from the corresponding author, subject to data sharing agreements.
